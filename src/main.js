...
document.querySelector('#app').innerHTML = `
  <header class="site-header">
    <div class="container header-inner">
      <a class="wordmark" href="/">Fendr.calis</a>
      <nav class="nav">
        <a class="nav-current" href="#navody">Návody</a>
    ...
    <section>
      <div class="container hero">
        <div class="hero-left">
          ...
          <h1 class="hero-headline">Všechno, co jsem kdy natočil, na jednom místě.</h1>
        ...
        <aside class="hero-card">
          ...
          <p class="card-fine">Nové návody přidávám průběžně. Sleduj Instagram, ať ti žádný neunikne.</p>
        </aside>
      </div>
    </section>
  ...
  <footer class="site-footer">
    <div class="container footer-inner">
      <span>© ${new Date().getFullYear()} Fendr.calis</span>
